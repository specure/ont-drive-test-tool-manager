...
package com.cadrikmdev.manager.presentation.about
...
import com.cadrikmdev.core.presentation.designsystem.ArrowRightIcon
...
fun InfoItemWebLink(title: String?, text: String?, url: String) {
    ...
    Box(
        ...
        Box(
            ...
            Icon(
                imageVector = ArrowRightIcon, contentDescription = null, tint = SignalTrackerManagerBlue,
                modifier = Modifier
                    .size(35.dp)
            )
        }
