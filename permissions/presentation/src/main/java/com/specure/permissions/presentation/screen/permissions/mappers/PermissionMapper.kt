package com.specure.permissions.presentation.screen.permissions.mappers
...
fun String.permissionToUiName(): Int {
    return when (this) {
        ...
        Manifest.permission.BLUETOOTH_CONNECT -> R.string.bluetooth_connect_permission
        Manifest.permission.BLUETOOTH_SCAN -> R.string.bluetooth_scan_permission
