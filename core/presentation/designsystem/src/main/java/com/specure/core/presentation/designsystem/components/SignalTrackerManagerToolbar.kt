...
import com.specure.core.presentation.designsystem.AnalyticsIcon
import com.specure.core.presentation.designsystem.ArrowLeftIcon
import com.specure.core.presentation.designsystem.LogoIcon
import com.specure.core.presentation.designsystem.Poppins
...
@Composable
fun SignalTrackerManagerToolbar(
...
@Preview
@Composable
fun SignalTrackerManagerToolbarPreview() {
    SignalTrackerManagerTheme {
        SignalTrackerManagerToolbar(
            showBackButton = true,
            title = "Signal Tracker Manager",
