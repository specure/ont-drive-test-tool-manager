...
class AndroidBluetoothBleServerService(
    ...
    private val characteristicUUID: UUID = UUID.randomUUID() // Replace with your own characteristic UUID
    ...
    private val gattServerCallback = object : BluetoothGattServerCallback() {
        ...
        override fun onCharacteristicReadRequest(
            ...
            if (characteristic.uuid == characteristicUUID) {
                ...
                gattServer?.sendResponse(device, requestId, BluetoothGatt.GATT_SUCCESS, offset, progress)
